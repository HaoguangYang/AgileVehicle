  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'steering_wheel' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'john <yhg14@mails.tsinghua.edu.cn>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'steering_wheel' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/mnt/Data/AgileV_dev/ROS/src/steering_wheel/${idir}'.  Ask the maintainer 'john <yhg14@mails.tsinghua.edu.cn>' to fix it.")
    endif()
