...
(cl:defmethod cl:initialize-instance :after ((m <joyinfoex>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'joyinfoex)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name agile_v_core-msg:<joyinfoex> is deprecated: use agile_v_core-msg:joyinfoex instead.")))

(cl:ensure-generic-function 'dwXpos-val :lambda-list '(m))
(cl:defmethod dwXpos-val ((m <joyinfoex>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader agile_v_core-msg:dwXpos-val is deprecated.  Use agile_v_core-msg:dwXpos instead.")
  (dwXpos m))

(cl:ensure-generic-function 'dwYpos-val :lambda-list '(m))
(cl:defmethod dwYpos-val ((m <joyinfoex>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader agile_v_core-msg:dwYpos-val is deprecated.  Use agile_v_core-msg:dwYpos instead.")
  (dwYpos m))

(cl:ensure-generic-function 'dwZpos-val :lambda-list '(m))
(cl:defmethod dwZpos-val ((m <joyinfoex>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader agile_v_core-msg:dwZpos-val is deprecated.  Use agile_v_core-msg:dwZpos instead.")
  (dwZpos m))

(cl:ensure-generic-function 'dwRpos-val :lambda-list '(m))
(cl:defmethod dwRpos-val ((m <joyinfoex>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader agile_v_core-msg:dwRpos-val is deprecated.  Use agile_v_core-msg:dwRpos instead.")
  (dwRpos m))

(cl:ensure-generic-function 'dwUpos-val :lambda-list '(m))
(cl:defmethod dwUpos-val ((m <joyinfoex>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader agile_v_core-msg:dwUpos-val is deprecated.  Use agile_v_core-msg:dwUpos instead.")
  (dwUpos m))

(cl:ensure-generic-function 'dwVpos-val :lambda-list '(m))
(cl:defmethod dwVpos-val ((m <joyinfoex>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader agile_v_core-msg:dwVpos-val is deprecated.  Use agile_v_core-msg:dwVpos instead.")
  (dwVpos m))

(cl:ensure-generic-function 'dwButtons-val :lambda-list '(m))
(cl:defmethod dwButtons-val ((m <joyinfoex>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader agile_v_core-msg:dwButtons-val is deprecated.  Use agile_v_core-msg:dwButtons instead.")
  (dwButtons m))

(cl:ensure-generic-function 'dwButtonNumber-val :lambda-list '(m))
(cl:defmethod dwButtonNumber-val ((m <joyinfoex>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader agile_v_core-msg:dwButtonNumber-val is deprecated.  Use agile_v_core-msg:dwButtonNumber instead.")
  (dwButtonNumber m))

(cl:ensure-generic-function 'dwPOV-val :lambda-list '(m))
(cl:defmethod dwPOV-val ((m <joyinfoex>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader agile_v_core-msg:dwPOV-val is deprecated.  Use agile_v_core-msg:dwPOV instead.")
  (dwPOV m))
