...
private:
    ...
    Semaphore* mutex;  //Usedd to lock threads in parallel processing. refer to ecl::Semaphore in ROS.
    bool cameraChanged;
    bool rectify;
    ...
    void printExtrinsic();
    bool loadStereoParameters(const string& stereoParamFile, Mat &KL, Mat &KR, Mat &DistL, Mat &DistR, Mat &Ro, Mat &T);
...
public:
    ...
    */
    StereoCamera(const string& stereoParamFile, bool rectify=true);
    ...
    */
    void initELAS(const string& filename);
