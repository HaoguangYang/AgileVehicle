...
!
data_element create variable  &
   variable_name = .MODEL_1.Vehicle_X_Out  &
   adams_id = 193  &
   initial_condition = 0.0  &
   function = ""
!
data_element create variable  &
   variable_name = .MODEL_1.Vehicle_Y_Out  &
   adams_id = 194  &
   initial_condition = 0.0  &
   function = ""
!
data_element create variable  &
   variable_name = .MODEL_1.Vehicle_Z_Out  &
   adams_id = 195  &
   initial_condition = 0.0  &
   function = ""
!
data_element create variable  &
   variable_name = .MODEL_1.Vehicle_V_X_Out  &
   adams_id = 196  &
   initial_condition = 0.0  &
   function = ""
!
data_element create variable  &
   variable_name = .MODEL_1.Vehicle_V_Y_Out  &
   adams_id = 197  &
   initial_condition = 0.0  &
   function = ""
!
data_element create variable  &
   variable_name = .MODEL_1.Vehicle_A_X_Out  &
   adams_id = 198  &
   initial_condition = 0.0  &
   function = ""
!
data_element create variable  &
   variable_name = .MODEL_1.Vehicle_A_Y_Out  &
   adams_id = 199  &
   initial_condition = 0.0  &
   function = ""
!
data_element create variable  &
   variable_name = .MODEL_1.Vehicle_A_Z_Out  &
   adams_id = 200  &
   initial_condition = 0.0  &
   function = ""
!
...
simulation script create  &
   ...
   commands =   &
              "simulation single_run transient type=auto_select initial_static=no end_time=50.0 number_of_steps=5000 model_name=.MODEL_1"
!
...
!
ude create instance  &
   instance_name = .MODEL_1.AgileV_4WD  &
...
variable modify  &
   ...
   string_value = "C:/MSC.Software/Adams_x64/2012/acar/shared_car_database.cdb/roads.tbl/2d_stochastic_uneven.rdf"
!
variable modify  &
...
!
variable modify  &
   variable_name = .MODEL_1.AgileV_4WD.input_channels  &
   object_value =   &
      .MODEL_1.SteeringAngle_fl,  &
      .MODEL_1.SteeringAngle_fr,  &
      .MODEL_1.SteeringAngle_rl,  &
      .MODEL_1.SteeringAngle_rr,  &
      .MODEL_1.DrvTrq_fl,  &
      .MODEL_1.DrvTrq_fr,  &
      .MODEL_1.DrvTrq_rl,  &
      .MODEL_1.DrvTrq_rr
!
variable modify  &
   variable_name = .MODEL_1.AgileV_4WD.output_channels  &
   object_value =   &
      .MODEL_1.Vehicle_X_Out,  &
      .MODEL_1.Vehicle_Y_Out,  &
      .MODEL_1.Vehicle_Z_Out,  &
      .MODEL_1.Vehicle_V_X_Out,  &
      .MODEL_1.Vehicle_V_Y_Out,  &
      .MODEL_1.Vehicle_A_X_Out,  &
      .MODEL_1.Vehicle_A_Y_Out,  &
      .MODEL_1.Vehicle_A_Z_Out
!
variable modify  &
   variable_name = .MODEL_1.AgileV_4WD.file_name  &
   string_value = "AgileV_4WD"
!
variable modify  &
   variable_name = .MODEL_1.AgileV_4WD.solver_type  &
   string_value = "fortran"
!
variable modify  &
   variable_name = .MODEL_1.AgileV_4WD.target  &
   string_value = "MATLAB"
!
variable modify  &
   variable_name = .MODEL_1.AgileV_4WD.analysis_type  &
   string_value = "non_linear"
!
variable modify  &
   variable_name = .MODEL_1.AgileV_4WD.analysis_init  &
   string_value = "no"
!
variable modify  &
   variable_name = .MODEL_1.AgileV_4WD.analysis_init_str  &
   string_value = ""
!
variable modify  &
   variable_name = .MODEL_1.AgileV_4WD.user_lib  &
   string_value = "AgileV_4WD"
!
variable modify  &
   variable_name = .MODEL_1.AgileV_4WD.host  &
   string_value = "SurfacePro4.tsinghua.edu.cn"
!
variable modify  &
   variable_name = .MODEL_1.AgileV_4WD.dynamic_state  &
   string_value = "on"
!
ude modify instance  &
   instance_name = .MODEL_1.AgileV_4WD
...
measure create object  &
   measure_name = .MODEL_1.Vehicle_Z  &
   from_first = no  &
   object = .MODEL_1.Chasis  &
   characteristic = cm_position  &
   component = y_component  &
   create_measure_display = no
!
data_element attributes  &
   data_element_name = .MODEL_1.Vehicle_Z  &
   color = WHITE
!
measure create object  &
   measure_name = .MODEL_1.Vehicle_X  &
   from_first = no  &
   object = .MODEL_1.Chasis  &
   characteristic = cm_position  &
...
!
data_element attributes  &
   data_element_name = .MODEL_1.Vehicle_X  &
   color = WHITE
!
measure create object  &
   measure_name = .MODEL_1.Vehicle_Y  &
   from_first = no  &
   object = .MODEL_1.Chasis  &
   characteristic = cm_position  &
...
!
data_element attributes  &
   data_element_name = .MODEL_1.Vehicle_Y  &
   color = WHITE
!
measure create object  &
   measure_name = .MODEL_1.Vehicle_V_Y  &
   from_first = no  &
   object = .MODEL_1.Chasis  &
...
!
data_element attributes  &
   data_element_name = .MODEL_1.Vehicle_V_Y  &
   color = WHITE
!
measure create object  &
   measure_name = .MODEL_1.Vehicle_V_Z  &
   from_first = no  &
   object = .MODEL_1.Chasis  &
   characteristic = cm_velocity  &
   component = y_component  &
...
!
data_element attributes  &
   data_element_name = .MODEL_1.Vehicle_V_Z  &
   color = WHITE
!
measure create object  &
   measure_name = .MODEL_1.Vehicle_V_X  &
   from_first = no  &
   object = .MODEL_1.Chasis  &
   characteristic = cm_velocity  &
   component = z_component  &
...
!
data_element attributes  &
   data_element_name = .MODEL_1.Vehicle_V_X  &
   color = WHITE
!
measure create object  &
   measure_name = .MODEL_1.Vehicle_A_X  &
   from_first = no  &
   object = .MODEL_1.Chasis  &
...
!
data_element attributes  &
   data_element_name = .MODEL_1.Vehicle_A_X  &
   color = WHITE
!
measure create object  &
   measure_name = .MODEL_1.Vehicle_A_Y  &
   from_first = no  &
   object = .MODEL_1.Chasis  &
   characteristic = cm_acceleration  &
   component = x_component  &
...
!
data_element attributes  &
   data_element_name = .MODEL_1.Vehicle_A_Y  &
   color = WHITE
!
measure create object  &
   measure_name = .MODEL_1.Vehicle_A_Z  &
   from_first = no  &
   object = .MODEL_1.Chasis  &
   characteristic = cm_acceleration  &
   component = y_component  &
...
!
data_element attributes  &
   data_element_name = .MODEL_1.Vehicle_A_Z  &
   color = WHITE
!
!---------------------------- Adams/View Variables ----------------------------!
!
...
data_element modify variable  &
   variable_name = .MODEL_1.Vehicle_X_Out  &
   function = ".MODEL_1.Vehicle_X"
!
data_element modify variable  &
   variable_name = .MODEL_1.Vehicle_Y_Out  &
   function = ".MODEL_1.Vehicle_Y"
!
data_element modify variable  &
   variable_name = .MODEL_1.Vehicle_Z_Out  &
   function = ".MODEL_1.Vehicle_Z"
!
data_element modify variable  &
   variable_name = .MODEL_1.Vehicle_V_X_Out  &
   function = ".MODEL_1.Vehicle_V_X"
!
data_element modify variable  &
   variable_name = .MODEL_1.Vehicle_V_Y_Out  &
   function = ".MODEL_1.Vehicle_V_Y"
!
data_element modify variable  &
   variable_name = .MODEL_1.Vehicle_A_X_Out  &
   function = ".MODEL_1.Vehicle_A_X"
!
data_element modify variable  &
   variable_name = .MODEL_1.Vehicle_A_Y_Out  &
   function = ".MODEL_1.Vehicle_A_Y"
!
data_element modify variable  &
   variable_name = .MODEL_1.Vehicle_A_Z_Out  &
   function = ".MODEL_1.Vehicle_A_Z"
!
